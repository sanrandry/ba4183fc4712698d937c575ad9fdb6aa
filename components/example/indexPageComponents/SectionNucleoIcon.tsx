...
export default function SectionNucleoIcon() {
    return (
                ...
                <div className="row justify-content-center">
                    <div className="col-lg-8 col-md-12">
                        ...
                        <h4 className="description">
                            BLK• Design System PRO comes with 100 custom icons
                            made by our friends from NucleoApp. The official
                            package contains over 2.100 thin icons which are
                            looking great in combination with BLK• Design System
                            PRO Make sure you check all of them and use those
